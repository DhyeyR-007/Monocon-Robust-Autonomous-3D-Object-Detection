...
_C.OUTPUT_DIR = "/home/drajani/Downloads/monocon_main/navarch565/CFG_OUTPUT_DIR"                           # Output Directory
_C.SEED = -1                                     # -1: Random Seed Selection
_C.GPU_ID = 0                                    # Index of GPU to use
 
_C.USE_BENCHMARK = False                          # Value of 'torch.backends.cudnn.benchmark' and 'torch.backends.cudnn.enabled' ##################### CHANGED #########################


# Data
_C.DATA = CN()
_C.DATA.ROOT = '/home/drajani/Downloads/monocon_main/monocon_na565/dataset'                  # Dataset directory ##################### CHANGED #########################
...
_C.MODEL.HEAD.MAX_OBJS = 50  ##################### CHANGED #########################
